...
- **Component architecture:** single responsibility, appropriate client/server rendering boundaries (hydration, lazy-loaded interactive parts).
- **Accessibility:** ARIA labels, keyboard navigation, semantic HTML, focus management, contrast.
- **Responsive:** layout, touch targets, viewport handling; verify the project's primary viewport first.
