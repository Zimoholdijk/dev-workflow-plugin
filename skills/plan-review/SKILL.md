...
4. **Assessor** runs: reads the full log, updates per-area recurrence counts, applies the tier -> behavior rules, decides converge or another round, and (on convergence) produces the test-obligation list for you to write into the plan.
